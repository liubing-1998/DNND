...
# (result_filename, item, network, True)
def different_A_initial_interpolation_extrapolation_longtime(dynamic, result_filename, initial_filename, network, init_random=True):
    logging.info("============================================")
    ...
    if init_random:
        ...
        logging.info("x0从对应initial文件中读出")
    ...
    # 模型参数初始化
    # x0 = results['true_y'][0][:, 0].unsqueeze(dim=-1).to(device)
    input_size = 1
    ...
    A = results_initial['A'][0].to(device)
    logging.info("A从对应的initial文件中读取")
    ...
    logging.info("id_test, id_test2, id_test3从对应initial文件中读出")
...
if __name__ == '__main__':
    ...
    log_filename = r'different_A_initial_interpolation_extrapolation_longtime/different_A_initial_all.txt'
    ...
    network_list = ['grid', 'random', 'power_law', 'small_world']
    for dynamic in dynamics:
        if dynamic=='HeatDynamics':
            result_filename = "results/HeatDynamics/community/result_HeatDynamics_community_0128-042640_0.pth"
        elif dynamic=='BiochemicalDynamics':
            # result_filename = "results/BiochemicalDynamics/community/result_BiochemicalDynamics_community_1217-122040_D0.pth"
            result_filename = "results/BiochemicalDynamics/community/result_BiochemicalDynamics_community_0128-092409_0.pth"
        elif dynamic=='BirthDeathDynamics':
            result_filename = "results/BirthDeathDynamics/community/result_BirthDeathDynamics_community_0128-143117_0.pth"
        ...
        for network in network_list:
            ...
            for item in file_name_list:
                different_A_initial_interpolation_extrapolation_longtime(dynamic, result_filename, item, network, True,)
